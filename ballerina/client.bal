...
public isolated client class Client {
    ...
    # + headers - Headers to be sent with the request 
    # + return - A successful response or an error 
    resource isolated function post v2/organizations/[string organizationId]/imports/bulk_users/add(ImportsAccountSettingsBody payload, map<string|string[]> headers = {}) returns OrganizationImportResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - A successful response or an error 
    resource isolated function post v2/organizations/[string organizationId]/accounts/[string accountId]/imports/bulk_users/add(ImportsAccountSettingsBody payload, map<string|string[]> headers = {}) returns OrganizationImportResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - A successful response or an error 
    resource isolated function post v2/organizations/[string organizationId]/imports/bulk_users/update(ImportsAccountSettingsBody payload, map<string|string[]> headers = {}) returns OrganizationImportResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - A successful response or an error 
    resource isolated function post v2/organizations/[string organizationId]/accounts/[string accountId]/imports/bulk_users/update(ImportsAccountSettingsBody payload, map<string|string[]> headers = {}) returns OrganizationImportResponse|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - A successful response or an error 
    resource isolated function post v2/organizations/[string organizationId]/imports/bulk_users/close(ImportsAccountSettingsBody payload, map<string|string[]> headers = {}) returns OrganizationImportResponse|error {
